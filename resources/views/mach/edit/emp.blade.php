...
@section('page')
    <div class="row row-cards">
        <div class="col-12">
            <form action="{{ route('emp.mach.Edit', $mach->code) }}" method="post" class="card">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="row mb-3">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" name="name"
                                    class="form-control @error('name') is-invalid @enderror" value="{{ $mach->name }}">
                                @error('name')
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" name="code"
                                    class="form-control @error('code') is-invalid @enderror" value="{{ $mach->code }}">
                                @error('code')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select type="text" name="dep"
                                    ...
                                    @foreach ($dep as $e)
                                        <option value="{{ $e->id }}"
                                            @if ($mach->dep_id == $e->id) selected @endif>
                                            {{ $e->name }} |
                                            {{ $e->code }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="note" class="form-control @error('note') is-invalid @enderror">{{ $mach->note }}</textarea>
                                @error('note')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
